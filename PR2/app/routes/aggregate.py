...
# GET /api/v1/aggregate/all/ — все автомобили с характеристиками (вложенный JSON)
...
# GET /api/v1/aggregate/make/ — avg/min/max HP по марке
...
# GET /api/v1/aggregate/transmission/ — avg/min/max HP по трансмиссии
...
# GET /api/v1/aggregate/vehicle-type/ — avg/min/max HP по типу кузова
...
# GET /api/v1/aggregate/year/ — avg/min/max HP по году выпуска
